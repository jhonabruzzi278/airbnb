...
import "./chunks/astro-designed-error-pages_DlcCXLF2.mjs";
import "kleur/colors";
import "./chunks/astro/server_DFM0Vk-K.mjs";
import "clsx";
import "cookie";
import { s as sequence } from "./chunks/index_UlZIs3Pv.mjs";
async function createAsyncLocalStorage() {
  const { AsyncLocalStorage } = await import("node:async_hooks");
  return new AsyncLocalStorage();
}
var authAsyncStorage = await createAsyncLocalStorage();
const __vite_import_meta_env__ = { "ASSETS_PREFIX": void 0, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "PUBLIC_CLERK_PUBLISHABLE_KEY": "pk_test_bmljZS10cm91dC01NC5jbGVyay5hY2NvdW50cy5kZXYk", "SITE": void 0, "SSR": true };
function getContextEnvVar(envVarName, contextOrLocals) {
  ...
  return Object.assign(__vite_import_meta_env__, { CLERK_SECRET_KEY: "sk_test_bv783f0IndNX45zDgUeqRYM94z3d1oweetdSemOZDR", Path: process.env.Path, PUBLIC: process.env.PUBLIC })[envVarName];
}
...
var createClerkClientWithOptions = (context, options) => createClerkClient({
  ...
  userAgent: `${"@clerk/astro"}@${"2.9.1"}`,
  sdkMetadata: {
    name: "@clerk/astro",
    version: "2.9.1",
    // eslint-disable-next-line turbo/no-undeclared-env-vars
    environment: Object.assign(__vite_import_meta_env__, { CLERK_SECRET_KEY: "sk_test_bv783f0IndNX45zDgUeqRYM94z3d1oweetdSemOZDR", Path: process.env.Path, PUBLIC: process.env.PUBLIC }).MODE
  },
  telemetry: {
...
const onRequest$1 = clerkMiddleware((auth, { request }) => {
  const { userId } = auth();
